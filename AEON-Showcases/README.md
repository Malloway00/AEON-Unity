...
> **Need a classroom-friendly starting point?** Jump directly to the [Educational Quick Links](#-educational-quick-links) below.
...
- [Gaelic Lineage Backtrace — Edu](Education/Gaelic_Lineage_Backtrace_Edu.md)
- [PIE Root *ḱerd-* Forward Drift — Edu](Education/PIE_Root_ḱerd_Forward_Drift_Edu.md)
- [Martian Dialect Evolution — Edu](Education/MARTIAN_DIALECT_EVOLUTION_2025–2175_Edu.md)
- [Felis domesticus Semiotic Drift — Edu](Education/FELIS_DOMESTICUS_SEMIOTIC_DRIFT_2025–3000_Edu.md)
